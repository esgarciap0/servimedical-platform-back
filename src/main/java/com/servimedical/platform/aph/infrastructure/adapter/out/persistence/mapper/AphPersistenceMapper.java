...
public class AphPersistenceMapper {
  ...
  public Aph toDomain(AphJpaEntity entity) {
    ...
    return Aph.builder()
            ...
            .tipoDocumentoProfesionalRecibe(entity.getTipoDocumentoProfesionalRecibe())
