...
public class AphPersistenceMapper {
  ...
  public Aph toDomain(AphJpaEntity entity) {
    ...
    return Aph.builder()
            ...
            .tipoServicioTransporte(entity.getTipoServicioTransporte())
            .codigoHabilitacionRecibeTransportePrimario(entity.getCodigoHabilitacionRecibeTransportePrimario())
            .direccionOrigenTransportePrimario(entity.getDireccionOrigenTransportePrimario())
            .direccionDestinoTransportePrimario(entity.getDireccionDestinoTransportePrimario())
